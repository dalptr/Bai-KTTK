            ...
            child: SizedBox(
              ...
              child: Wrap(
                ...
                children: [
                  ...
                  _productChild(
                      'assets/images/television.png', 'Televisions', 105),
                  _productChild(
                      'assets/images/dryer.png', 'Dryers/Styling', 65),
                  _productChild(
                      'assets/images/headphone.png', 'Headphones', 77),
                  _productChild('assets/images/tablet.png', 'Tablet', 28),
                  _productChild(
                      'assets/images/mobile-covers.png', 'Mobile Covers', 68),
                  _productChild('assets/images/printers.png', 'Printers', 44),
                  _productChild(
                      'assets/images/healthcare.png', 'Healthcare', 89),
                  _productChild('assets/images/powerbank.png', 'Powerbank', 71),
                  _productChild(
                      'assets/images/smartwatch.png', 'Smartwatches', 34),
      ...
      child: Column(
        ...
        children: [
          Stack(
            children: [
              Image.asset(image,
                  width: (MediaQuery.of(context).size.width - 125) / 2 - 10,
                  height: 90),
              Positioned(
                right: 5,
                top: 5,
                child: Container(
                  padding: EdgeInsets.symmetric(
                      vertical: 5, horizontal: value > 99 ? 1.5 : 5),
            ...
            Container(
              ...
              child: Container(
                ...
                child: Image.asset(image,
                    width: 25,
                    height: 25,
                    color: action == title ? null : Colors.grey),
              ),
            ),
            Text(title,
                style: TextStyle(
                    color: action != title ? Colors.grey : Colors.pink,
                    fontSize: 15,
